...
const Lucia = () => {
  ...
  return (
    <section className='lucia-life'>
        ...
        <div className="flex flex-col gap-5 items-end lg:1/2 ps-10 mt-96 img-box">
        ...
        <div className="lg:w-1/2 lucia-life-content">
            <div className='max-w-xl lg:ps-8 ps-10'>
            <h1>Lucia Caminos</h1>
            ...
            <p className='max-w-xl lg:ps-10 ps-10'>More than anything, Lucia wants the good life her mom has dreamed of since their days in Liberty City — but instead of half-baked fantasies, Lucia is prepared to take matters into her own hands.</p>
        </div>
    </section>
  )
}
